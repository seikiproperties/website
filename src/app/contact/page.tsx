  ...
  return (
    <>
      ...
      <section className="section bg-cream-light">
        <div className="container-x grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-14">
          <div>
            <h2 className="text-navy text-xl font-medium mb-6">Reach us directly</h2>
            <div className="space-y-5">
              <ContactRow label="Dubai" value={siteConfig.contact.dubaiPhone} href={`tel:${siteConfig.contact.dubaiPhoneHref}`} />
              <ContactRow label="India" value={siteConfig.contact.indiaPhone} href={`tel:${siteConfig.contact.indiaPhoneHref}`} />
              ...
              >
                <span className="eyebrow text-gold-dark w-16 shrink-0">WhatsApp</span>
          ...
          <div className="bg-white border border-navy/10 p-8 md:p-10">
            <h2 className="text-navy text-xl font-medium mb-1">Tell us about your investment</h2>
...
function ContactRow({ label, value, href }: { label: string; value: string; href: string }) {
  return (
    <a href={href} className="flex items-center gap-3 group">
      <span className="eyebrow text-gold-dark w-16 shrink-0">{label}</span>
      <span className="text-navy text-sm group-hover:text-gold-dark transition-colors">{value}</span>
    </a>
  );
}
